...
lib.makePageList = function(client, items) {
    items.forEach(function(item) {
        item.placementList = item.placementList ? soapUtils.makeTypedList(
            'Placement',
            item.placementList,
            'http://systinet.com/wsdl/de/adtech/helios/WebsiteManagement/'
        ) : undefined;
    });
