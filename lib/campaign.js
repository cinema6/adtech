...
lib.getCampaignStatusValues = function(client,idList,boolExpr){
    var nil = soapUtils.nil, isEmpty = soapUtils.isEmpty,
        processResponse = soapUtils.processResponse, hashMapify = soapUtils.hashMapify,
        params = {};
    ...
    return require('q').ninvoke(client,'getCampaignStatusValues',params).then(function(result){
            if (isEmpty(result[0])){
                return [];
            }
