...
lib.isAPIObject = function(obj){
    return ((!lib.isEmpty(obj)) && ((!lib.isEmpty(obj.attributes)) || obj.$value)) ?
        true : false;
};
...
lib.hashMapify = function(obj){
    var res, keyCount, i;
    if (obj.Keys && obj.Values) {
        res = {};
        keyCount = Object.keys(obj.Keys).length;
...
lib.makeTypedList = function(ns,typeName,items,pfx){
    var theList = {
        Items : {
            attributes : { },
            Item : [ ]
